...
namespace IDCA.Bll.MDMDocument
{
    ...
    internal static class LanguageHelper
    {
        ...
        internal static string GetShortCodeFromLongCode(string longCode)
        {
            ...
            if (!_longCodeToShortCode.ContainsKey(longCode.ToLower()))
            {
                return string.Empty;
            }
            return _longCodeToShortCode[longCode.ToLower()];
        }
        ...
        internal static string GetNameFromLongCode(string longCode)
        {
            ...
            if (!_longCodeToName.ContainsKey(longCode.ToLower()))
            {
                return string.Empty;
            }
            return _longCodeToName[longCode.ToLower()];
        }
